(function () {
    ...
    if (root.__AES_ROUTE_REGISTRY__) {
        return;
    }

    // AES route compatibility registry.
    //
    // This is the single source of truth for routes that AES may intercept and
    ...
    // Pages where AES must stay completely hands-off after navigation.
    ...
    root.__AES_ROUTE_REGISTRY__ = routes;
})();
